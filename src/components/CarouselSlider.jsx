...
const CarouselSlider = () => {
  return (
    <>
      ...
      >
        <div>
          <div className="bg-[#5B3E45]  h-[100vh] items-center">
            <div className=" max-w-[93%] mx-auto">
              <div className="flex h-[100vh] justify-start items-center my-website-logo my-grid-carousel md:flex-row sm:flex-wrap">
                <div className="flex h-[47%] my-website-logo-holder mt-8 justify-start items-start">
                  <svg
                    aria-labelledby="aesop-145"
                    className="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8 w-1/3"
                  ...
                  >
                    <title aria-label="Aesop logo" id="aesop-145">
                      Aesop
                    </title>
                    <g>
                ...
                <div className="flex flex-col text-start items-start text-white ms-[5rem] w-[52%] my-paragraph-carousel">
                  <h3 className="mb-3">Supporting city skin</h3>
                  ...
                  <button className="outline outline-offset-1 outline-white outline-1 flex justify-between p-3 py-5 mt-3 w-[53%] hover:bg-[#fffef2] hover:text-[#333] hover:outline-[0] carousel-button">
        ...
        <div>
          <div className="bg-[#333333]  h-[100vh] items-center">
            <div className=" max-w-[93%] mx-auto">
              <div className="flex h-[100vh] mt-8 justify-start items-center my-website-logo my-grid-carousel md:flex-row sm:flex-col">
                <div className="flex h-[47%] my-website-logo-holder mt-8 justify-start items-start">
                  <svg
                    aria-labelledby="aesop-145"
                    className="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8 w-1/3"
                ...
                <div className="flex flex-col text-start items-start text-white ms-[5rem] w-[33%] my-paragraph-carousel">
                  <h3 className="mb-3">Hand and Body Care</h3>
                  <h2 className="mb-3 text-[30px]">Buoyant bodies</h2>
                  <p className="mb-3">
                  ...
                  <button className="outline outline-offset-1 outline-white outline-1 flex justify-between p-3 py-5 mt-3 w-[53%] hover:bg-[#fffef2] hover:text-[#333] hover:outline-[0] carousel-button">
                    <a href="#">Discover Body & Hand Care</a>
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
        ...
        <div>
          <div className="bg-[#F6F5E8]  h-[100vh] items-center">
            <div className=" max-w-[93%] mx-auto">
              <div className="flex h-[100vh] mt-8 justify-start items-center my-website-logo my-grid-carousel md:flex-row sm:flex-col">
                <div className="flex h-[47%] my-website-logo-holder mt-8 justify-start items-start">
                  <svg
                ...
                <div className="flex flex-col text-start items-start text-black ms-[5rem] w-[33%] my-paragraph-carousel">
                  <h3 className="mb-3">Supporting city skin</h3>
                  <h2 className="mb-3 text-[30px]">
                    Parsley Seed Anti-Oxidant Intense Serum
                  </h2>
                  ...
                  <button className="outline outline-offset-1 outline-black outline-1 flex justify-between p-3 py-5 mt-3 w-[53%] hover:bg-[#333] hover:text-[#fffef2] hover:outline-[0] carousel-button">
                    <a href="#">Discover Ouranon</a>
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
